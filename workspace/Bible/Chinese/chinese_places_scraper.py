...
if __name__ == "__main__":
    ...
    for i in letterLIST:
        ...
        if chLIST != None:
            with open("../../../data/Bible/Chinese/names/chinese_places.json", "r", encoding="utf-8") as f:
                old_chLIST = json.load(f)       
            with open("../../../data/Bible/Chinese/names/chinese_places.json", "w", encoding="utf-8") as f:
                for i in chLIST:
                    old_chLIST.append(i)  
