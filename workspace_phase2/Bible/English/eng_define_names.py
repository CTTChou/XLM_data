...
def main(jsonFILE, userDefined):
    ...
    for tagSTR, nameLIST in userDefinedDICT.items():   #e.g. tagSTR= "ENTITY_Person"
        for nameSTR in nameLIST:
            EngBibleLIST = replace_tag(EngBibleLIST, tagSTR, nameSTR)
          
    #完成處理後，寫回 JSON
    with open(jsonFILE, "w", encoding="utf-8") as f:
        json.dump(EngBibleLIST, f, ensure_ascii=False, indent=4)            
        pprint(EngBibleLIST[:2])    #只印出處理檔案的前兩個元素看一下
...
if __name__ == "__main__":
    userDefined = "../../../data_phase2/Bible/English/UserDefinedFile.json"    
    
    all_Bible = "../../../data_phase2/Bible/English/POS_all_EngBible.json"  
    
    folderLIST = ["../../../data_phase2/Bible/English/POS"]
